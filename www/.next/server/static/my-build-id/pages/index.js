...
var style_css_ = __webpack_require__("WZvO");
...
// EXTERNAL MODULE: ./utils/domain.ts
var domain = __webpack_require__("oFlI");
...
// CONCATENATED MODULE: ./services/io.ts


var io_domain = "".concat(Object(domain["a" /* getDomain */])(), "/io");
var io_init = function init() {
  var socket = external_socket_io_client_default()(io_domain, {
    query: {
  ...
  socket.on('new_app_msg', function (data) {
    console.log(data);
  });
  socket.on('new_user_msg', function (data) {
    console.log(data);
  });
  socket.on('check_user_msg', function (data) {
    console.log(data);
  });
  socket.emit('check_user_msg');
  socket.on('check_app_msg', function (data) {
    console.log(data);
  });
  socket.on('read_app_msg', function (data) {
    console.log(data);
  });
...
function (_Component) {
  ...
  function Index() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "socket", null);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "renderAppTitle", function () {
      return external_react_default.a.createElement("div", null, "\u5E94\u7528\u6D88\u606F", external_react_default.a.createElement(link_default.a, {
        href: "/post/app_msg"
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "readAppMsg", function (id) {
      console.log(id);

      _this.socket.emit('read_app_msg', id);
    });
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(msg["c" /* queryAppMsg */])({});

              case 2:
                app_msgs = _context.sent;
