...
module.exports = __webpack_require__("gtD3");
...
/* harmony import */ var antd_lib_table_style_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("WZvO");
/* harmony import */ var antd_lib_table_style_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(antd_lib_table_style_css__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var antd_lib_button_style_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("7d7u");
...
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("pI2v");
...
/* harmony import */ var _services_msg__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("pCbk");
/* harmony import */ var _services_staff__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("oiPc");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(Index, _Component);
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(this, Index);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(this, (_getPrototypeOf2 = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(Index)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_this), "socket", null);

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_this), "renderUserTitle", function () {
      return react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("div", null, "\u7528\u6237\u6D88\u606F", react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_16___default.a, {
        href: "/post/user_msg"
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_this), "readUserMsg", function (id) {
      console.log(id);

      _this.socket.emit('read_user_msg', id);
    });

    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(Index, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_17___default()('http://127.0.0.1:7070/io', {
        query: {
      ...
      this.socket.on('new_app_msg', function (data) {
        console.log(data);
      });
      this.socket.on('new_user_msg', function (data) {
        console.log(data);
      });
      this.socket.on('check_user_msg', function (data) {
        console.log(data);
      });
      this.socket.emit('check_user_msg');
      this.socket.on('check_app_msg', function (data) {
        console.log(data);
      });
      this.socket.on('read_app_msg', function (data) {
        console.log(data);
      });
    ...
    value: function render() {
      ...
      var user_msgs = this.props.user_msgs;
      var readUserMsg = {
        title: '操作',
        dataIndex: 'handle',
        render: function render(_value, row) {
          return react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_7___default.a, {
            onClick: function onClick() {
              return _this2.readUserMsg(row._id);
            }
          }, "\u8BFB");
        }
      };
      return react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(antd_lib_card__WEBPACK_IMPORTED_MODULE_3___default.a, {
        title: this.renderUserTitle(),
        style: {
          marginTop: 25
        }
      }, react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(antd_lib_table__WEBPACK_IMPORTED_MODULE_5___default.a, {
        columns: [readUserMsg].concat(userColumns),
        dataSource: user_msgs
      })));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var user_msgs, staffs;
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_services_msg__WEBPACK_IMPORTED_MODULE_18__[/* queryUserMsg */ "d"])({});

              case 2:
                user_msgs = _context.sent;
                _context.next = 5;
                return Object(_services_staff__WEBPACK_IMPORTED_MODULE_19__[/* queryStaff */ "a"])({
                  method: 'GET'
                });
